      ...
      <main>
        ...
        <section className="section_2">
          <div className="sec2_img">
            <img
              src="https://ecom-static-site-prod.s3.ap-south-1.amazonaws.com/Courses/Camps/Weight_management.jpg"
              alt=""
            />
          </div>
        ...
        <section className="section_3">
          <div className="int_img_text21">
            ...
            <div className="int_img21">
              <img
                src="https://ecom-static-site-prod.s3.ap-south-1.amazonaws.com/Landing_page/Hansaji.jpg"
                alt=""
              />
            </div>
          </div>
