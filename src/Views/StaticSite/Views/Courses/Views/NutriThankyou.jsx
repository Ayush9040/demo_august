    ...
    <div id="overlay">
      ...
      <div id="text">
        ...
        <p className="thankyou">Payment Successful</p>
         ...
         <p className="message">
          Congratulations on taking a step towards leading life the Yogic Way & spreading joy across the world. You have been successfully enrolled for Nutri Diet Course.
