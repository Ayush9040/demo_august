  ...
  return (
    <div className="highlight-sections">
      ...
      <div className="about-section">
        ...
        <p>The corporate workshops are of 6 hours duration and have particularly useful contents. The broad contents are as under:</p>
        <ul>
          <li> Related Asanas</li>
          <li>Various techniques of Pranayama</li>
          <li>Conscious Relaxation Techniques</li>
          <li>Kriyas – cleaning and strengthening of eyes, nose, and throat.</li>
          <li>‘Sattvic’ diet food at appropriate intervals that helps beat stress.</li>
          <li> Interactive games based on yogic concepts.</li>
        </ul>
        <p>These workshops are unique, refreshing, and enjoyable for the participants.</p>
        <p>We conduct these workshops at our Institute. Alternatively, we can conduct them at your office as well. The workshops can be tailor-made to suit your or the organization’s specific requirements.</p>
        <div className='contact-info'>
          <div className='contact'>Contact:</div>
          <ul>
            <li>Please contact our Institute and ask for “Corporate Workshops” division.</li>
            ...
            <li>
Or (2) Ms. Pranee Yogendra – 8879955000
            </li>
          </ul>
        </div>
      </div>
