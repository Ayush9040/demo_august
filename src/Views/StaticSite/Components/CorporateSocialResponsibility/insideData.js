...
export const CsrIn = [

  {
    ...
    sliderImg:[
      `${baseDomain}${csrBmc.ab1}`,
      `${baseDomain}${csrBmc.ab2}`,
      `${baseDomain}${csrBmc.ab3}`,
      `${baseDomain}${csrBmc.ab4}`,
      `${baseDomain}${csrBmc.ab5}`,
      `${baseDomain}${csrBmc.ab6}`,
      `${baseDomain}${csrBmc.ab7}`,
      `${baseDomain}${csrBmc.ab8}`,
      `${baseDomain}${csrBmc.ab9}`,
      `${baseDomain}${csrBmc.ab10}`,
      `${baseDomain}${csrBmc.ab11}`,
      `${baseDomain}${csrBmc.ab12}`,
      `${baseDomain}${csrBmc.ab13}`,
      `${baseDomain}${csrBmc.ab14}`,
      `${baseDomain}${csrBmc.ab15}`,
      `${baseDomain}${csrBmc.ab16}`,
      `${baseDomain}${csrBmc.ab17}`,
      `${baseDomain}${csrBmc.ab18}`,
      `${baseDomain}${csrBmc.ab19}`,
      `${baseDomain}${csrBmc.ab20}`,
...

  {
    ...
    alt:'Yoga Education for BMC School Children',
...

  {
    ...
    alt : 'Yoga for Children with Special Needs',
    ...
    sliderImg : [
      `${baseDomain}${csrBmc.yfsk1}`,
      `${baseDomain}${csrBmc.yfsk2}`,
      `${baseDomain}${csrBmc.yfsk3}`,
      `${baseDomain}${csrBmc.yfsk4}`,
      `${baseDomain}${csrBmc.yfsk5}`,
      `${baseDomain}${csrBmc.yfsk6}`,
      `${baseDomain}${csrBmc.yfsk7}`,
      `${baseDomain}${csrBmc.yfsk8}`,
      `${baseDomain}${csrBmc.yfsk9}`,
      `${baseDomain}${csrBmc.yfsk10}`,
      `${baseDomain}${csrBmc.yfsk11}`,
      `${baseDomain}${csrBmc.yfsk12}`,
      `${baseDomain}${csrBmc.yfsk13}`,
      `${baseDomain}${csrBmc.yfsk14}`,
      `${baseDomain}${csrBmc.yfsk15}`,
      `${baseDomain}${csrBmc.yfsk16}`,
      `${baseDomain}${csrBmc.yfsk17}`,
      `${baseDomain}${csrBmc.yfsk18}`,
      `${baseDomain}${csrBmc.yfsk19}`,
      `${baseDomain}${csrBmc.yfsk20}`,
      `${baseDomain}${csrBmc.yfsk21}`,
      `${baseDomain}${csrBmc.yfsk22}`,
...

  {
    ...
    sliderImg : [
      ...
      `${baseDomain}${csrBmc.ta2}`,
      `${baseDomain}${csrBmc.ta3}`,
      `${baseDomain}${csrBmc.ta4}`,
      `${baseDomain}${csrBmc.ta5}`,
      `${baseDomain}${csrBmc.ta6}`,
      `${baseDomain}${csrBmc.ta1}`,
      `${baseDomain}${csrBmc.ta7}`,
      `${baseDomain}${csrBmc.ta8}`,
      `${baseDomain}${csrBmc.ta9}`,
      `${baseDomain}${csrBmc.ta10}`,
      `${baseDomain}${csrBmc.ta11}`,
    ]
  },
...

  {
    ...
    alt : 'Yoga for Transgender/LGBTQ Community',
    ...
    sliderImg : [
      `${baseDomain}${csrBmc.trans1}`,
      `${baseDomain}${csrBmc.trans2}`,
      `${baseDomain}${csrBmc.trans3}`,
      `${baseDomain}${csrBmc.trans4}`,
      `${baseDomain}${csrBmc.trans5}`,
      `${baseDomain}${csrBmc.trans6}`,
      `${baseDomain}${csrBmc.trans7}`,
      `${baseDomain}${csrBmc.trans8}`,
      `${baseDomain}${csrBmc.trans9}`,
      `${baseDomain}${csrBmc.trans10}`,
      `${baseDomain}${csrBmc.trans11}`,
...

  {
    ...
    sliderImg : [
      `${baseDomain}${csrBmc.tp1}`,
      `${baseDomain}${csrBmc.tp2}`,
      `${baseDomain}${csrBmc.tp3}`,
      `${baseDomain}${csrBmc.tp4}`,
      `${baseDomain}${csrBmc.tp5}`,
      `${baseDomain}${csrBmc.tp6}`,
      `${baseDomain}${csrBmc.tp7}`,
      `${baseDomain}${csrBmc.tp8}`,
      `${baseDomain}${csrBmc.tp9}`,
      `${baseDomain}${csrBmc.tp10}`,
      `${baseDomain}${csrBmc.tp11}`,
    ]
  },

  {
    ...
    sliderImg : [
      `${baseDomain}${csrBmc.kyc1}`,
      `${baseDomain}${csrBmc.kyc2}`,
      `${baseDomain}${csrBmc.kyc3}`,
      `${baseDomain}${csrBmc.kyc4}`,
      `${baseDomain}${csrBmc.kyc5}`,
      `${baseDomain}${csrBmc.kyc6}`,
      `${baseDomain}${csrBmc.kyc7}`,
    ]
  }
]