...
const UpcomingDatesView = ({ pageDate, setCourseDateInfo, setCourseDateSelected, closeModal, setShowDefaultDate, setNotShowDate, formData, setFormData, courseDateInfo }) => {
...
export default UpcomingDatesView
