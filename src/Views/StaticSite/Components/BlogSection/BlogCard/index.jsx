  ...
  return (
    <div className="blog-card" onClick={ ()=>{navigate(`/${ blogs?.slug }`)} } >
      <div className="blog-card-image">
        <img src={blogs?.coverImage || 'https://ecom-static-site-prod.s3.ap-south-1.amazonaws.com/SEO-New-Images/Courses/yoga-teacher-training-courses-hero.webp'} loading='lazy' />
      </div>
