...
export const testimonialData = [
  {
    ...
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/landing-page/testimonial1.png',
    message:
  ...
  },
  {
    ...
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/landing-page/testimonial2.png',
    message:
  ...
  },
  {
    name: 'Nikita Wadhwa',
    info: 'Sadhaka',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/landing-page/testimonial3.png',
    message:
  ...
  },
  {
    ...
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/landing-page/testimonial4.png',
    message:
...
export const testimonialData2 = [
  {
    ...
    info: '',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Landing_page/1.png',
    message:
  ...
  },
  {
    ...
    info: '',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Landing_page/2.png',
    message:
  ...
  },
  {
    ...
    info: '',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Landing_page/3.png',
    message:
...
export const testimonialData3 = [
  {
    name: 'Shvetika Kaul',
    info: '',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Nutri-Clinic/Shvetika%20Kaul.jpg',
    message:
  ...
  },
  {
    name: 'Pallavi Raj',
    info: '',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Nutri-Clinic/Pallavi.jpg',
  ...
  },
  {
    name: 'Aditi kaku',
    info: '',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Nutri-Clinic/Aditi-kaku.jpg',
    message:
...
export const testimonialData4 = [
  {
    ...
    info: 'Student from Canada',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/seven-days/Brianne.png',
  ...
  },
  {
    ...
    info: 'Sadhaka',
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/seven-days/Parineeta.png',
...
export const CampsWorkShops = [
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Courses/Camps/Stress_Management_Camp.jpeg',
    text: 'Stress Management Camp',
    url: '/stress-management-camp',
  },
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Courses/Camps/Weight_Management_Workshop.jpeg',
    text: 'Weight Management Workshop',
    url: '/weight-management-workshop',
  },
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Courses/Camps/Diabetes_Camp.jpeg',
    url: '/diabetes-camp',
    text: 'Diabetes Camp',
  },
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Courses/Camps/Cardiac_Hypertension_Workshop.jpeg',
    url: '/cardiac-hypertension-workshop',
    text: 'Cardiac & Hypertension Workshop',
  },
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Courses/Camps/Back_Joint_Disorder_Workshop.jpeg',
...
export const landingFeaturedBlogs =[
  {
    img:'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Landing_page/1ttc.jpg',
  ...
  {
    img:'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Landing_page/impyoga.jpg',
...
export const landingFeaturedBlogs2 =[
  {
    img:'https://theyogainstituteprod.oss-ap-southeast-1.aliyuncs.com/uploads/2022/07/21-Days-Better-Living-Course.jpeg',
    text:'New to Yoga? Take this 21 Day Challenge',
    url:'/new-to-yoga-twenty-one-days-challenge'
  },
  {
    img:'https://theyogainstituteprod.oss-ap-southeast-1.aliyuncs.com/uploads/2020/08/yoga-preparation-tyi-blog.jpg',
...
export const NutriClinicBlogs =[
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Nutri-Clinic/nutri1.jpg',
    text:'Why  should i adopt a sattvik diet',
    url:'/why-should-i-adopt-a-sattvik-diet'
  },
  {
    img:'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/Nutri-Clinic/nutri2.jpg',
...
export const SevenBlogs =[
  {
    img: 'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/seven-days/importance-and-benefits-of-yoga.jpg',
    text:'Importance and benefits of yoga',
    url:'/importance-and-benefits-of-yoga'
  },
  {
    img:'https://ecom-static-site-prod.oss-ap-southeast-1.aliyuncs.com/seven-days/Yoga-Dos-and-Donts-for-Beginners.jpg',
