...
export const locateData =[
  {
    ...
    branches :[
      ...
      {
        state:'Rishikesh',
        notstate:'The Yoga Institute Rishikesh, BHAVAN, House No. 4, Gali No. 4, Ward No. 1 Shri Badri Kedar Colony Lakkad ghat, Khadri khadakmaaf Yoga Nagri Rishikesh Uttarakhand - 249204',
