...
export const volunteerData = [
  {
    ...
    gallery: [
      {
        img1: `${baseDomain}${socialResponsibilityAssets.annamBrahma}`,
        img2: `${baseDomain}${socialResponsibilityAssets.bmcSchool}`,
        img3: `${baseDomain}${socialResponsibilityAssets.police}`,
        img4: `${baseDomain}${socialResponsibilityAssets.trafficPolice}`,
        img5: `${baseDomain}${socialResponsibilityAssets.truckAsana}`,
        img6: `${baseDomain}${socialResponsibilityAssets.palnting}`,
      },
    ],
    faq: [
      { id:1,
