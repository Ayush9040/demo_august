...
export const data=[
  {
    ...
    post:' MD, Adfactors',
    alt:'Madan Bahal',
    info:'I first went to The Yoga Institute in November 1989. Back then, I was going through unusual circumstances and was in a state of depression. The 2 days Stress Management Camp that I attended and an encounter with Dr. Jayadeva altered the course of my life. Today I’ve staff members who have stayed with me for over 30 years now and this is because of the ideals that the Institute has inculcated in me.',
    img:[
      `${baseDomain}${experienceAssets.madanBahal}`,
      `${baseDomain}${experienceAssets.madanBahal}`,
      `${baseDomain}${experienceAssets.madanBahal}`,
      `${baseDomain}${experienceAssets.madanBahal}`,
      `${baseDomain}${experienceAssets.madanBahal}`,
  ...
  },
  {
    ...
    info:'I’ve been part of The Yoga Institute since over two decades now. I would say that I have not only personally benefitted from the teachings but also introduced the corporate training program to our team at Brescon. I would most certainly recommend this course to all corporate executives who wish to be benefitted through ancient science of Yoga. When practiced regularly, the Yoga techniques taught in this program help in stress management and enhancing the quality of professional and personal life.',
    img:[
      `${baseDomain}${experienceAssets.nirmalGangwal}`,
      `${baseDomain}${experienceAssets.nirmalGangwal}`,
      `${baseDomain}${experienceAssets.nirmalGangwal}`,
      `${baseDomain}${experienceAssets.nirmalGangwal}`,
      `${baseDomain}${experienceAssets.nirmalGangwal}`,
  ...
  },
  {
    ...
    info:'I joined The Yoga Institute four years back and since then there is no looking back. Joining The Yoga Institute has been the wisest decision of my life. Smt. Hansaji has helped me replace disturbances in my life with sheer happiness. It has not only helped me in my singing career but as an individual also. Its been a great experience & now Yoga has become an essential part of my life.',
    img:[
      `${baseDomain}${experienceAssets.sukhwinderSingh}`,
      `${baseDomain}${experienceAssets.sukhwinderSingh}`,
      `${baseDomain}${experienceAssets.sukhwinderSingh}`,
      `${baseDomain}${experienceAssets.sukhwinderSingh}`,
      `${baseDomain}${experienceAssets.sukhwinderSingh}`,
  ...
  },
  {
    ...
    info:'I’m a proud student of The Yoga Institute. I joined the institute in late 1960’s when people weren’t aware about Yoga & thought it was close to being a Sanyasi. The Yoga Institute has changed my perspective towards Yoga i.e., it is not only about Asana but it is a much deeper subject. Yoga has become an essential part of my life. Dr. Saab’s teachings have really helped me in my life & I consider myself to be fortunate enough to learn Yoga from him. This spiritual abode brings in happy memories & you get to experience peace within. I will always remember this quote of Dr. Saab “Less is More”. ',
    img:[
      `${baseDomain}${experienceAssets.shivKumarSharma}`,
      `${baseDomain}${experienceAssets.shivKumarSharma}`,
      `${baseDomain}${experienceAssets.shivKumarSharma}`,
      `${baseDomain}${experienceAssets.shivKumarSharma}`,
      `${baseDomain}${experienceAssets.shivKumarSharma}`,
  ...
  },
  {
    ...
    alt:'Shweta Tiwari',
    post:'Film actress',
    info:'This is the first time I’m doing Yoga and I’m enjoying it a lot; I feel really relaxed. My teacher from The Yoga Institute makes the whole process quite simple and fun for me. I am in my last week of pregnancy and I regret not starting Yoga before. I might continue my Yoga lessons even after my delivery.Thank you for this great experience',
    img:[
      `${baseDomain}${experienceAssets.shwetaTiwari}`,
      `${baseDomain}${experienceAssets.shwetaTiwari}`,
      `${baseDomain}${experienceAssets.shwetaTiwari}`,
      `${baseDomain}${experienceAssets.shwetaTiwari}`,
      `${baseDomain}${experienceAssets.shwetaTiwari}`,
  ...
  // {
  //   id:6,
  //   alluminiimg:`${baseDomain}${experienceAssets.}`,
  ...
  // },
  {
    ...
    info:'For me Yoga is about changing yourself rather than changing other people. It’s about complete surrender. Both good and bad things happen because they are both inevitable. We must learn to accept what comes our way and move on. Asanas and pranayamas , when done daily definitely aide physical and mental development. Other than that, maintaining a daily routine where one gets up early in the morning and sleeps on time, eats on time, etc. really helps one perform better. ',
    img:[
      `${baseDomain}${experienceAssets.premchandgodha}`,
      `${baseDomain}${experienceAssets.premchandgodha}`,
      `${baseDomain}${experienceAssets.premchandgodha}`,
      `${baseDomain}${experienceAssets.premchandgodha}`,
      `${baseDomain}${experienceAssets.premchandgodha}`,
  ...
  },
  {
    ...
    alt:'Shilpa Shirodkar',
    post:'Film Actor',
    info:'I am training with a teacher from The Yoga Institute. My experience with learning and training in Yoga has been marvellous. The quality of the teaching and the teacher surely makes the difference as it not only includes my training but it has also made me aware of the benefits of practicing every posture. Yoga is not only a workout pattern, it is a life changing process. Many thanks to The Yoga Institute for all the help ',
    img:[
      `${baseDomain}${experienceAssets.shilpaShirodkar}`,
      `${baseDomain}${experienceAssets.shilpaShirodkar}`,
      `${baseDomain}${experienceAssets.shilpaShirodkar}`,
      `${baseDomain}${experienceAssets.shilpaShirodkar}`,
      `${baseDomain}${experienceAssets.shilpaShirodkar}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.ankitaSood}`,
      `${baseDomain}${experienceAssets.ankitaSood}`,
      `${baseDomain}${experienceAssets.ankitaSood}`,
      `${baseDomain}${experienceAssets.ankitaSood}`,
      `${baseDomain}${experienceAssets.ankitaSood}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.dishaVakhani}`,
      `${baseDomain}${experienceAssets.dishaVakhani}`,
      `${baseDomain}${experienceAssets.dishaVakhani}`,
      `${baseDomain}${experienceAssets.dishaVakhani}`,
      `${baseDomain}${experienceAssets.dishaVakhani}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.ajankiya}`,
      `${baseDomain}${experienceAssets.ajankiya}`,
      `${baseDomain}${experienceAssets.ajankiya}`,
      `${baseDomain}${experienceAssets.ajankiya}`,
      `${baseDomain}${experienceAssets.ajankiya}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.carlo}`,
      `${baseDomain}${experienceAssets.carlo}`,
      `${baseDomain}${experienceAssets.carlo}`,
      `${baseDomain}${experienceAssets.carlo}`,
      `${baseDomain}${experienceAssets.carlo}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.rujutaDiwekar}`,
      `${baseDomain}${experienceAssets.rujutaDiwekar}`,
      `${baseDomain}${experienceAssets.rujutaDiwekar}`,
      `${baseDomain}${experienceAssets.rujutaDiwekar}`,
      `${baseDomain}${experienceAssets.rujutaDiwekar}`,
  ...
  },
  {
    ...
    img:
    [
      `${baseDomain}${experienceAssets.veronica}`,
      `${baseDomain}${experienceAssets.veronica}`,
      `${baseDomain}${experienceAssets.veronica}`,
      `${baseDomain}${experienceAssets.veronica}`,
      `${baseDomain}${experienceAssets.veronica}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.natalia}`,
      `${baseDomain}${experienceAssets.natalia}`,
      `${baseDomain}${experienceAssets.natalia}`,
      `${baseDomain}${experienceAssets.natalia}`,
      `${baseDomain}${experienceAssets.natalia}`,
  ...
  },
  {
    ...
    img:[
      `${baseDomain}${experienceAssets.kavita}`,
      `${baseDomain}${experienceAssets.kavita}`,
      `${baseDomain}${experienceAssets.kavita}`,
      `${baseDomain}${experienceAssets.kavita}`,
      `${baseDomain}${experienceAssets.kavita}`,
