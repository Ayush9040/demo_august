...
// Import Swiper styles - make sure these are included in your project
import 'swiper/css';
...
> */}
                ...
                {/* <div
  className="slider-track"
  style={{ transform: `translateX(calc(-${currentIndex * 100}% + ${currentIndex === 0 ? 0 : 10}%))` }}
  onTouchStart={handleTouchStart}
  onTouchEnd={handleTouchEnd}
> */}
                ...
                <div
                  className="slider-track"
                  style={{
                    transform: `translateX(calc(-${currentIndex * 60}% - ${currentIndex * 10}px + 20%))`
                  }}
                  onTouchStart={handleTouchStart}
                  onTouchEnd={handleTouchEnd}
                >
