...
import baseDomain, { homeAssets, museumAssets } from '../../assets/images/imageAsset'
const Museum = () => {
  const intro =
        ...
        {numberofSlides.map((item, i) => {
          return (
            <div key={i} className='museum-card-wrapper'>
              ...
              <p className='vt_text' >
                Want to see what the Shri Yogendra Museum looks like from the
                inside? Here’s your chance to take on a virtual tour;
              </p>
