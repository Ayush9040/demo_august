...
export const data = [
  {
    ...
    gallery: [
      ...
      `${baseDomain}${aboutAssets.aboutAsset30}`,
      `${baseDomain}${aboutAssets.aboutAsset31}`,
      `${baseDomain}${aboutAssets.aboutAsset32}`,
      `${baseDomain}${aboutAssets.aboutAsset33}`,
  ...
  },
  {
    ...
    gallery: [
      ...
      `${baseDomain}${aboutAssets.aboutAsset22}`,
      `${baseDomain}${aboutAssets.aboutAsset23}`,
      `${baseDomain}${aboutAssets.aboutAsset24}`,
      `${baseDomain}${aboutAssets.aboutAsset25}`,
  ...
  },
  {
    ...
    gallery: [
      `${baseDomain}${aboutAssets.aboutAsset37}`,
      `${baseDomain}${aboutAssets.aboutAsset38}`,
      `${baseDomain}${aboutAssets.aboutAsset39}`,
      `${baseDomain}${aboutAssets.aboutAsset40}`,
      `${baseDomain}${aboutAssets.aboutAsset41}`,
  ...
  },
  {
    ...
    Shri Yogendra Ji's guide and spiritual master, Shri Madhavdas Ji, was introduced to him by the Universe in a marvelous way.`,
  ...
  },
  {
    ...
    gallery: [
      ...
      `${baseDomain}${aboutAssets.aboutAsset4}`,
      `${baseDomain}${aboutAssets.aboutAsset5}`,
      `${baseDomain}${aboutAssets.aboutAsset6}`,
      `${baseDomain}${aboutAssets.aboutAsset7}`,
