...
const CourseDetails = ({ pageDate }) => {
  ...
  const displayNote = ( course )=>{
    switch( course ){
    case 'pregnancy-camp-for-ante-post-natal': return <p>*Please note, the camp is open only for women after 3 months of pregnancy till the 9 months of pregnancy.</p>
    case '7-days-camp': return <p>*Please Note: The fees of 7 Days Health Camp - On Campus - Hindi is getting revised from January 2023.
   ...
   Rs. 34,000/- Single Occupancy </p>
    case '7-days-camp-english': return <p>*Please Note: The fees of 7 Days Health Camp - On Campus - Hindi is getting revised from January 2023.
   Below is the revision of fees:
    <br/>
   Rs. 13,000/- Triple Sharing
    <br/>
   Rs. 20,000/- Dual Sharing
    <br/>
   Rs. 34,000/- Single Occupancy </p>
    case '200-hrs-part-time-ttc-online': return <p>
   *Please Note: The fees of 2-months TTC Online-Hindi is getting revised from January 2023.
   Below is the revision of fees:
      <br/>
   Online: Rs. 25,000/-</p>
    case '200-hrs-part-time-ttc-on-campus-english': return <p>
   *Please Note: The fees of 2-months TTC Online & On Campus - English  is getting revised from January 2023.
   ...
   Residential: Rs. 80,000/-
    ...
    default: return <p>*Join on any date</p>
    }
  }
      ...
      <div className="course-detail-page" id="registration">
        <div className="main-section" style={{ background: '#C9705F' }}>
          <div className="course-info">
            ...
            {pageDate?.join === true && (
              <p style={{ marginTop: '1.5rem' , fontSize:'1.25rem' }}>{displayNote(pageDate?.key)}</p>
