...
import { getByYearYogsattva } from './Api'
...
const Yogasattva = () => {
  ...
  const handleYearlyData = (year) => {
    getByYearYogsattvaData(year)
  }
    ...
    <>
      ...
      <div className="previous-background">
        ...
        <div className="publication-nav-dates">
          <PublicationDateNav bold={bold} setBold={setBold} handleYearlyData={handleYearlyData} />
        </div>
        <div>
